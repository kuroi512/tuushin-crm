                  ...
                  >
                    {header.isPlaceholder
                      ...
                      : (() => {
                          ...
                          const cls = `flex items-center space-x-1 ${header.column.getCanSort() ? 'cursor-pointer select-none' : ''} ${meta?.className ?? 'px-1 py-0.5'} ${stickyLeft !== undefined ? 'z-20 bg-background' : ''}`;
                          return (
                            <div
                              className={cls}
                              style={style}
                ...
                {row.getVisibleCells().map((cell) => (
                  <TableCell key={cell.id}>
                    {(() => {
                      ...
                      const cls = `${meta?.className ?? 'px-1 py-0.5'} ${stickyLeft !== undefined ? 'z-10 bg-background' : ''}`;
                      return (
